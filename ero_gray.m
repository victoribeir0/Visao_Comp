function saida = ero_gray(imagem,est,val)
% Erosão em escala de cinza.
...
for i = 2:m-1
    for j = 2:n-1
        ...
        % Realiza a subtração, obtém o mínimo e coloca o resultado na saída.
        saida(i-1,j-1) = min(vet1 - vet2);
    end
end
